...
const Footer = () => {
  return (
    <>
      {/* Blue CTA Section */}
      <section className="cta-blue-section">
        <div className="container">
          <h2>Ready to Find Your Perfect Houston Community?</h2>
          <p>Start your journey today and discover the ideal neighborhood for your lifestyle.</p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', marginTop: '32px' }}>
            <Link to="/communities" className="btn btn-white">
              Explore Communities <i className="fas fa-arrow-right" style={{ marginLeft: '8px' }}></i>
            </Link>
